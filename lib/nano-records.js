...
var NanoRecord = (function () {
    ...
    NanoRecord.prototype.attachmentFind = function (name, callback) {
    ...
    NanoRecord.prototype.attachmentStream = function (name, mimetype, callback) {
        if (callback === void 0) { callback = function () { }; }
    ...
    NanoRecord.prototype.attachmentDestroy = function (name, callback, tries) {
        if (callback === void 0) { callback = function () { }; }
        if (tries === void 0) { tries = 0; }
        if (!this.data['_id']) {
            callback(new Error('Document does not exist.'));
...
var NanoRecords = (function () {
    ...
    NanoRecords.prototype.docsCreate = function (data, callback, tries) {
        if (callback === void 0) { callback = function () { }; }
        if (tries === void 0) { tries = 0; }
        tries++;
    ...
    NanoRecords.prototype.docsFind = function (id, callback) {
        if (callback === void 0) { callback = function () { }; }
    ...
    NanoRecords.prototype.docsUpdate = function (id, data, callback) {
        if (callback === void 0) { callback = function () { }; }
        this.docsFind(id, function (err, instance) {
            if (err)
                callback(err);
            else
    ...
    NanoRecords.prototype.docsDestroy = function (id, callback) {
        if (callback === void 0) { callback = function () { }; }
        this.docsFind(id, function (err, instance) {
            if (err)
                callback(err);
