...
describe('util view', () => {
  ...
  it('generateName', () => {
    ...
    expect(ViewUtil.generateName(["key2", "key1", "key3"])).to.equal("key1_K_key2_K_key3_A_");
    ...
    expect(ViewUtil.generateName(["key2", "key1", "key3"], ["value2", "value1", "value3"])).to.equal("key1_K_key2_K_key3_A__S_value1_V_value2_V_value3_A_");
